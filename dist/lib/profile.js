...
export function adjustedTarget(goal, cityTier) {
...
const LIVING_BASE = { metro: 28000, tier1: 20000, tier2: 15000, tier3: 11000 };
export function estimatedLiving(p) {
...
export function monthlySurplus(p) {
...
export function suggestedSip(p) {
