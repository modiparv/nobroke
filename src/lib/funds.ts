...
export const ASSET_CLASSES: Record<AssetClassId, AssetClass> = {
  equity: { id: "equity", label: "Equity", color: "#1A1AFF", blurb: "Owning companies. Highest long-run growth." },
  debt: { id: "debt", label: "Debt", color: "#111111", blurb: "Lend for steady, predictable income." },
  gold: { id: "gold", label: "Gold", color: "#A89A7C", blurb: "Inflation hedge and diversifier." },
  hybrid: { id: "hybrid", label: "Hybrid", color: "#4B4BE6", blurb: "Equity + debt blend in one fund." },
};
