...
export const ASSET_CLASSES: Record<AssetClassId, AssetClass> = {
  equity: { id: "equity", label: "Equity", color: "#7F77DD", blurb: "Owning companies. Highest long-run growth." },
  debt: { id: "debt", label: "Debt", color: "#1D9E75", blurb: "Lend for steady, predictable income." },
  gold: { id: "gold", label: "Gold", color: "#EF9F27", blurb: "Inflation hedge and diversifier." },
  hybrid: { id: "hybrid", label: "Hybrid", color: "#2CC295", blurb: "Equity + debt blend in one fund." },
};
