...
export const btnIntake =
  "inline-flex h-14 items-center justify-center gap-2 whitespace-nowrap rounded-2xl bg-accent-fill px-8 text-base font-medium text-on-accent transition hover:bg-accent-fill-hi active:opacity-90 disabled:cursor-not-allowed disabled:bg-line-2 disabled:text-text-2";
