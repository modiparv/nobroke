...
/**
 * The portfolio room, in two halves. LEFT: the live portfolio — presets, the
 * fund universe, sliders, the macro backdrop — exactly what the plan runs on
 * today. RIGHT: the bucket studio, where a portfolio is curated by hand from
 * the whole instrument pool and applied only when it is ready. Draft on the
