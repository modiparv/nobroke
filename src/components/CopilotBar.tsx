...
function TypingDots() {
  return (
    <div className="flex w-fit items-center gap-1 rounded-2xl rounded-bl-sm border border-line bg-paper px-3.5 py-3">
      {[0, 0.2, 0.4].map((d, i) => (
          ...
          <div className="mb-2 overflow-hidden rounded-2xl border border-white/50 bg-white">
            <header className="flex items-center gap-2.5 border-b border-line px-4 py-2.5">
              ...
              <div className="flex-1">
                ...
                <div className="font-mono text-[9px] uppercase tracking-wide text-muted">looking after your goals</div>
              </div>
              <button
                onClick={actions.closeChat}
                className="font-mono text-[10px] uppercase tracking-wide text-muted transition hover:text-ink"
              >
                Clear
              </button>
              <button
                ...
                aria-label="Collapse"
                className="grid h-7 w-7 place-items-center rounded-lg text-muted transition hover:bg-paper hover:text-ink"
              >
                ↓
              </button>
            </header>
